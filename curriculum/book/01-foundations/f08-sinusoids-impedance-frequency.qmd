...
This chapter is complete enough for teaching and technical review. Its numerical
examples and executable output have been checked, and its schematics have been
rendered and inspected. The synthetic sweep data teach analysis but are not
physical measurements; Lab L05 is the evidence step.
:::
...
How can one unchanged circuit pass a slow signal almost intact, attenuate a fast
signal, and shift the timing between input and output?
