...
This behavior can lead to two incomplete explanations: “a transistor is a
switch,” or “a transistor amplifies current.” Neither statement identifies the control
terminal, the controlled path, or the intended operating region. Neither tells
us how much drive the device needs, where the load line places the operating
point, or what happens during the transition.
...
insufficient drive, stored charge, stray inductance, temperature rise, or a
