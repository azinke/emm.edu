...
- Source continue protégée approuvée : 0–6,1 V, limite réglée ≤20 mA.
...
15. Comparez les candidates R4 avec marge pour 1,40–1,52 V et ≤0,25 mA.
16. Isolez, montez R4 choisie, inspectez, mesurez et acceptez/refusez les deux exigences.

| N° | État | De→vers | Valeur brute/unité | Calibre/résolution | Incertitude élargie/base | Prévision | Résidu | Décision/anomalie |
|---:|---|---|---|---|---|---|---|---|
| 1 | initial | VS→COM | | | | | | |
| 2 | initial | TP-A→COM | | | | | | |
| 3 | initial | TP-B→COM | | | | | | |
...
Acceptez uniquement si la preuve physique enregistrée montre
(1,40\le V_B\le1,52\text{ V}) et un courant de source ≤0,25 mA, avec source,
composants, instrument, ambiance et incertitude déclarés. La réussite simulée de
